...
If your users attempt to login to i2b2 by means other than the patched web client (for example, the admin client or the workstation client), users will be presented with i2b2's usual login screens, and the user will need to present the password stored in the `PM_USER_DATA` table. 
